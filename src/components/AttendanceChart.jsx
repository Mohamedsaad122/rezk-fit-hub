    ...
    return (
        <Card className="border-0 shadow-md bg-gradient-card">
            <CardHeader className="text-right pb-2">
                <CardTitle className="text-base font-bold text-foreground">نشاط الحضور الأسبوعي</CardTitle>
                <CardDescription className="text-xs text-muted-foreground">نسب حضور الجلسات وتأكيد المواعيد حسب اليوم</CardDescription>
            </CardHeader>
