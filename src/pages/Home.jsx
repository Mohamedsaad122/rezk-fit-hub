    ...
    return (
        <div className="min-h-full bg-gradient-to-br from-background via-muted/20 to-background">
                            ...
                            <div className="relative bg-gradient-card rounded-3xl p-8 shadow-2xl">
                                <div className="grid grid-cols-2 gap-6">
                                    {stats.map((stat, index) => (
                                        ...
                                        >
                                            <div className={`w-16 h-16 ml-auto rounded-2xl bg-gradient-primary flex items-center justify-center shadow-lg`}>
                            ...
                            >
                                <Card className="h-full hover-lift bg-gradient-card border-0 shadow-md">
                                    <CardHeader className="text-center pb-6">
                                        <div className={`w-20 h-20 ml-auto rounded-2xl bg-gradient-to-r ${feature.gradient} flex items-center justify-center shadow-lg mb-4`}>
            ...
            <section className="py-20 px-6">
                <motion.div
                    className="max-w-4xl ml-auto text-center"
                    initial={{ opacity: 0, y: 50 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8 }}
                    viewport={{ once: true }}
                    ...
                    <Card className="bg-gradient-primary text-white border-0 shadow-2xl">
                        <CardContent className="p-12">
                            <div className="space-y-6">
                                ...
                                <p className="text-xl opacity-90 max-w-2xl ml-auto">
